...
description: Executes small, fully-specified frontend tasks (tier: junior). Mechanical work following existing patterns. Only dispatched by the techlead with a task file from .squad/stories/.
model: haiku
---

# Frontend Junior — Pocket Squad
