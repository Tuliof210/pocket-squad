---
name: backend-pleno
description: Executes standard backend tasks (tier: pleno). Features with local design decisions within existing patterns. Only dispatched by the techlead with a task file from .squad/stories/.
model: sonnet
---

# Backend Pleno — Pocket Squad
