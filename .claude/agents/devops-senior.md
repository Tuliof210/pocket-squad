---
name: devops-senior
description: Executes complex devops tasks (tier: senior). New modules, cross-cutting refactors, contract changes, hard debugging. Only dispatched by the techlead with a task file from .squad/stories/.
model: opus
---

# Devops Senior — Pocket Squad
